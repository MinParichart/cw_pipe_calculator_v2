      ...
      <div class="px-4 py-6 sm:px-0">
        ...
        <div class="mb-6">
          ...
          <p class="mt-1 text-sm text-gray-600">
            คำนวณขนาดท่อน้ำดีตามมาตรฐาน Hunter's Curve และ Hazen-Williams
            Formula
          </p>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div class="lg:col-span-2 space-y-6">
            ...
            <!-- Fixtures Input -->
            <FixtureInput v-model:fixtures="fixtures" :floor-number="1" />
          ...
          <div class="space-y-6">
            ...
            <div id="hybrid-sizing">
              <div
                class="bg-gradient-to-r from-purple-600 to-purple-700 rounded-lg p-4 mb-4 shadow-lg"
              >
                <div class="flex items-center">
                  <div
                    class="h-12 w-12 rounded-full bg-white bg-opacity-20 flex items-center justify-center mr-3"
                  >
                    <svg
                  ...
                  <div class="flex-1">
                    ...
                    <p class="text-purple-100 text-sm">
                      เปรียบเทียบ Table 2.6 กับ Hazen-Williams Formula
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div
                v-else
                class="card text-center py-8 border-2 border-dashed border-purple-300 bg-purple-50"
              >
                <svg
                  class="h-16 w-16 mx-auto mb-4 text-purple-400"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
                ...
                <h4 class="text-lg font-bold text-purple-900 mb-2">
                  เลือก Project และ Network ก่อน
                </h4>
                <p class="text-sm text-purple-700">
                  เพื่อเริ่มเปรียบเทียบขนาดท่อ
                </p>
              </div>
            </div>
            ...
            <div id="auto-suggest">
              <div
                class="bg-gradient-to-r from-orange-600 to-orange-700 rounded-lg p-4 mb-4 shadow-lg"
              >
                <div class="flex items-center">
                  <div
                    class="h-12 w-12 rounded-full bg-white bg-opacity-20 flex items-center justify-center mr-3"
                  ...
                  <div class="flex-1">
                    ...
                    <p class="text-orange-100 text-sm">
                      วิเคราะห์และแนะนำขนาดท่อที่เหมาะสมที่สุด
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div
                v-else
                class="card text-center py-8 border-2 border-dashed border-orange-300 bg-orange-50"
              >
                <svg
                  class="h-16 w-16 mx-auto mb-4 text-orange-400"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
            ...
            <div
              v-if="result"
              class="card bg-blue-600 bg-opacity-5 border-primary"
            >
              ...
              <div class="space-y-2">
                <div class="flex justify-between items-center">
                  ...
                  <span class="text-sm font-bold text-blue-600"
                    >{{ result.totalFlowRate }} GPM</span
                  >
                </div>
                <div class="flex justify-between items-center">
                  <span class="text-sm text-gray-600"
                    >Total Fixture Units:</span
                  >
                  <span class="text-sm font-bold text-blue-600"
                    >{{ result.totalFixtureUnits }} FU</span
                  >
                </div>
                <div class="flex justify-between items-center">
                  <span class="text-sm text-gray-600">ขนาดท่อที่แนะนำ:</span>
                  <span class="text-sm font-bold text-blue-600">{{
                    result.recommendedPipeSize
                  }}</span>
                </div>
                <div class="flex justify-between items-center">
                  ...
                  <span
                    ...
                    :class="
                      result.remainingPressure >= minRequiredPressure
                        ? 'text-green-600'
                        : 'text-red-600'
                    "
                  >
            ...
            <div v-if="result && showSteps" class="card">
              ...
              <div class="space-y-3 text-sm">
                ...
                >
                  <span
                    class="flex-shrink-0 h-5 w-5 rounded-full bg-blue-600 bg-opacity-10 flex items-center justify-center mr-2 mt-0.5"
                  >
...
import { networksApi, projectsApi } from "~/composables/useApi";
...
const canCalculate = computed(() => {
  ...
  return hasFixtures && pipeLength.value > 0 && cFactor.value > 0;
});
...
const calculate = async () => {
  ...
  try {
    ...
    const totalFU = Object.entries(fixtures.value).reduce(
    ...
    const fixtureCount = Object.values(fixtures.value).filter(
      (v: any) => v > 0
    ).length;
    calculationSteps.value = [
      {
...
const onPipeUpsizeApplyAll = (
  suggestions: Array<{ pipeId: number; suggestedSize: string }>
) => {
